...
"""Compatibility wrapper. Real implementation moved to `pyside6_glass.examples._showcase_app_impl`."""
...
_IMPL_MODULE = "pyside6_glass.examples._showcase_app_impl"
...
def __getattr__(name: str):
    if hasattr(_impl, name):
        _warn_symbol_access(f"pyside6_glass.examples.showcase_app.{name}", f"{_IMPL_MODULE}.{name}")
...
_warn_module_access("pyside6_glass.examples.showcase_app", _IMPL_MODULE)
