...
## Comandos utiles
```powershell
py -3 "F:\repos\hitech-os\apps\code-atlas\capatch_system\capatch.py" --plugin-health
py -3 "F:\repos\hitech-os\apps\code-atlas\capatch_system\capatch.py" --plugin-list
py -3 "F:\repos\hitech-os\apps\code-atlas\capatch_system\tooling\capatch_plugin_factory.py" --interactive --run-health-check
```
