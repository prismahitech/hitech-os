...
class ResultsPanel(QFrame):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.selection_chip = create_chip("No selection", tone="neutral", icon="preview", parent=self)
        header.addWidget(self.mode_chip, 0)
        header.addWidget(self.count_chip, 0)
        header.addWidget(self.selection_chip, 0)
        ...
        self.table.itemActivated.connect(lambda item, _column: self._emit_item(item))
    ...
    def set_loading(self, message: str) -> None:
        ...
        self.table.setVisible(False)
        self.selection_chip.setText("Loading")
        self.preview.set_lines([message])
    ...
    def _emit_item(self, item: QTreeWidgetItem | None) -> None:
        if item is None:
            return
    ...
    def _on_selection_changed(self) -> None:
        ...
        self.selection_chip.setText(str(row.get("session_id") or row.get("record_type") or "Selected"))
