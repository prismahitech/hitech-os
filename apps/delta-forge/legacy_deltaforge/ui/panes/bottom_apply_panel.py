...
class BottomApplyPanel(QWidget):
    """Apply surface scoped by session inputs."""
    ...
    def _build_ui(self) -> None:
        ...
        summary_box = QGroupBox('Apply Summary', self)
    ...
    def set_apply_result(self, result: Mapping[str, Any] | None) -> None:
