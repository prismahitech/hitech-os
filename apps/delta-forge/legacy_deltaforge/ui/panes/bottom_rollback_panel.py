...
class BottomRollbackPanel(QWidget):
    """Rollback surface scoped by session inputs."""
    ...
    def _build_ui(self) -> None:
        ...
        summary_box = QGroupBox('Rollback Summary', self)
    ...
    def set_rollback_result(self, result: Mapping[str, Any] | None) -> None:
