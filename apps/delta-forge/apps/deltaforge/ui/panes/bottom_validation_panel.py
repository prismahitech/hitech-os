...
class BottomValidationPanel(QWidget):
    """Validation surface scoped by session inputs."""
    ...
    def _build_ui(self) -> None:
        ...
        summary_box = QGroupBox('Validation Summary', self)
    ...
    def set_validation_result(self, result: Mapping[str, Any] | None) -> None:
